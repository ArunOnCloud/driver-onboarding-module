...
import com.arun.practice.documentsservice.conf.StorageProperties;
import com.arun.practice.documentsservice.exception.StorageException;
...
public class StorageServiceImpl implements StorageService {
    ...
    public Stream<Path> loadAll() {
        try {
            ...
            log.info("Current directory path:"+currentPath);
